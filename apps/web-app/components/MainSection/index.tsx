    ...
    return (
        <div className="flex flex-col min-h-[100vh] bg-[#EEEEF0] p-5 gap-10">
            <div className="overflow-hidden w-full h-full flex justify-between lg:flex-row flex-col py-5 px-[28px] md:px-[48px] bg-white rounded-[16px] gap-[100px] lg:gap-10">
                ...
                <div className="p-5 relative w-full lg:w-3/6 h-[300px] sm:h-[400px] lg:h-[500px] flex justify-center items-center">
                    <div className="absolute bottom-0 border border-black w-[550px] h-[300px] bg-eventbg2 filter blur-[150px] z-[1]" />
            ...
            {/* Connect Passport and Full Program prompt -- only when disconnected */}
            {isUserConnected && (
                <div className="w-full bg-white p-4 rounded-lg flex flex-col md:flex-row md:items-center md:justify-between">
                    <p className="font-semibold text-lg leading-7 text-[#1C2928] mb-4 md:mb-0 md:ml-10">
                        Get access to tickets and build your schedule!
                    </p>
                    <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 md:pl-10 md:mr-10">
                        <button className="flex justify-center items-center px-12 py-2 w-full md:px-32 md:w-auto h-10 bg-[#1C2928] rounded-md text-[#F8FFFE] font-semibold uppercase text-sm leading-7 whitespace-nowrap">
                            <span className="flex items-center">
                                <div className="flex items-center mr-2">
                                    <NextImage src="/connect_passport.png" alt="Icon" width={16} height={16} />
                                </div>
                                CONNECT PASSPORT
                            </span>
                        </button>
                        <button className="flex justify-center items-center px-12 py-2 w-full md:px-32 md:w-auto h-10 bg-[#1C2928] rounded-md text-[#F8FFFE] font-semibold uppercase text-sm leading-7 whitespace-nowrap">
                            <span className="flex items-center">
                                <div className="flex items-center mr-2">
                                    <NextImage src="/full_program.png" alt="Icon" width={16} height={16} />
                                </div>
                                FULL PROGRAM
                            </span>
                        </button>
            ...
            <div className="flex flex-col bg-white py-[40px] px-[36px] rounded-[8px] gap-10">
                <div className="flex flex-col md:flex-row md:gap-0 gap-5  w-full justify-between items-start">
                    ...
                    {/* Full Program Button -- only when connected */}
                    {!isUserConnected && (
